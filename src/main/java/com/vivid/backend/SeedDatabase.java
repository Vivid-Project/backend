...
class SeedDatabase {
  ...
  CommandLineRunner initDatabase(UserRepository userRepository, DreamRepository dreamRepository,
    ...
    // return args -> {
    // User user1 = userRepository.save(new User("Mike Jones",
    // "mjones@example.com"));
    // User user2 = userRepository.save(new User("Ava Drew", "adrew@example.com"));

    // Dream dream1 = dreamRepository
    // .save(new Dream("02/22/2021", "Cool Dream", "This is a good dream", "Happy",
    // user1));
    // Dream dream2 = dreamRepository.save(new Dream("02/23/2021", "Bad Dream",
    // "This was scary", "Bad", user1));
    // Dream dream3 = dreamRepository.save(new Dream("02/22/2021", "Weird Dream",
    // "This was very weird", "Fun", user2));
